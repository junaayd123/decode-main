...
public class scenarioclosered extends OpMode {
    ...
    private final Pose secondlinepickuppose = new Pose(56, 55, Math.toRadians(0));
    ...
    private void buildBezierPaths() {
        ...
        bezierSecondPath = follower.pathBuilder()
                .addPath(new Path(new BezierCurve(secondlinepickuppose, midpoint2, nearshotpose2)))
                .setLinearHeadingInterpolation(secondlinepickuppose.getHeading(), nearshotpose2.getHeading(), 0.8)
                .build();
    }
