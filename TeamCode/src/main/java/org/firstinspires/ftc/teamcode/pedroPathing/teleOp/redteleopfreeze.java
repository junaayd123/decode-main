...
@TeleOp(name = "red teleop freeze", group = "z")
public class redteleopfreeze extends OpMode {
...
//    boolean alignToTags;
    ...
    private redteleopfreeze.Mode mode = Mode.nothing;
