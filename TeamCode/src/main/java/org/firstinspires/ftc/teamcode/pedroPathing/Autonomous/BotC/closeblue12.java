...
@Autonomous(name = "Close Blue 12", group = "Pedro")
public class closeblue12 extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("Close Blue 12 initialized (3 walls, no gates)");
        telemetry.update();
    }
