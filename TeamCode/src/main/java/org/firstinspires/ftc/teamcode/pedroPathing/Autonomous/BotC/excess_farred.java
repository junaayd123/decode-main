 ...
 *
 * Poses: farshotpose family from state_farredoptimized
 * Excess area: from scenariofarred
 */
@Autonomous(name = "excess_farred", group = "Pedro")
public class excess_farred extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("excess_farred initialized | preload → third → excess → 2x gate collect");
        telemetry.update();
    }
