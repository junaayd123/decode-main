...
@Autonomous(name = "Closeblue 18 gate", group = "Pedro")
public class closeblue18gate extends OpMode {
    ...
    // ========== CONSTANTS ==========
    private static final double SHOOT_INTERVAL = 0.215;
    ...
    private static final int TOTAL_GATE_CYCLES = 3;
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 1: // Shoot while moving back (first 3 shots)
                depo.updatePID();
            ...
            case 16: // First line shoot done → get out
                if (actionState == 0) {
                    intake.setPower(1);
                    buildGetOutPath();
                    setPathState(17);
