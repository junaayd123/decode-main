...
@Autonomous(name = "Closeblue 18", group = "Pedro")
public class closeblue18 extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 16: // First line shoot done → go to third line pickup
                if (actionState == 0) {
                    intake.setPower(1);
                    setPathState(20);
                }
            ...
            case 24: // Third line shoot done → get out
                if (actionState == 0) {
                    intake.setPower(1);
                    buildGetOutPath();
                    setPathState(17);
