...
@Autonomous(name = "C-Bot Close Red new intake", group = "Pedro")
public class optimizedclosered_newIntaking extends OpMode {
...
//                manageSecondHopIntake();
            ...
            case 4: // Wait for first bezier path
                manageSecondHopIntake(); //outside of if statement to always check
                if (!follower.isBusy()) {
//                    manageSecondHopIntake();
            ...
            case 8: // Gate - start the "wait at gate position"
                if (!follower.isBusy()) {
...
//                    manageSecondHopIntake();
    ...
    private void manageSecondHopIntake() {
        ...
        if (!startIntake && actionTimer.getElapsedTimeSeconds() < 3 && actionTimer.getElapsedTimeSeconds() > 0) {
            intake.setPower(1); // Reverse for 3 seconds
            led.setPosition(0.5);
        } else if (!startIntake && actionTimer.getElapsedTimeSeconds() >= 3) {
